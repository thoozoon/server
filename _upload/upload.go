...
const baseURL = "https://comp3007-f25.scs.carleton.ca"

const requestURL = "/upload/" + "fioD0aiZeer6ahzoovohs7Asheishepaefei8ue1taecuzohph8eeyaiphiel3oh"
...
func main() {
	...
	url := baseURL + filepath.Join(requestURL, filepath.Base(filename))
